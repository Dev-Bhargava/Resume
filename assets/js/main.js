    ...
    vedioActivation: function (e) {
      $("#play-video, .play-video").on("click", function (e) {
        ...
        $("#video-overlay, .video-overlay").append(
          '<iframe width="80%" height="80%" src="https://www.youtube.com/embed/" frameborder="0" allowfullscreen></iframe>'
        );
      });
...
$(document).on("click", "#resume-form .rn-btn", function () {
  ...
  if (hrname != "" && hremail != "" && hrorganization != "") {
    ...
    self
      .parents("#resume-form")
      .find("#hrEmail")
      .css("border-color", "#ff7c7c");
    self
      .siblings(".form-error")
      .text("Enter your email so we can stay in touch.");
    self.siblings(".form-error").show();
...
$(document).on("click", "#submit", function (e) {
  ...
  let contactUsername = $("#contact-name").val().trim();
  let contactUserphone = $("#contact-phone").val().trim();
  let contactUseremail = $("#contact-email").val().trim();
  let contactUsersubject = $("#subject").val().trim();
  let contactUsermessage = $("#contact-message").val().trim();
  let _self = $(this);
  let callApi = false;
  ...
  if (contactUsername === "") {
    $("#contact-name").css("border-color", "#ff7c7c");
    _self.siblings(".contact-form-error").text("Enter your name here:").show();
  } else if (contactUseremail === "") {
    $("#contact-email").css("border-color", "#ff7c7c");
    _self.siblings(".contact-form-error").text("Enter your email here:").show();
  } else if (!emailRegex.test(contactUseremail)) {
    $("#contact-email").css("border-color", "#ff7c7c");
    _self
      .siblings(".contact-form-error")
      .text("Enter a valid email address.")
      .show();
  } else if (contactUsersubject === "") {
    $("#subject").css("border-color", "#ff7c7c");
    _self
      .siblings(".contact-form-error")
      .text("What would you like to talk about?")
      .show();
  } else if (contactUsermessage === "") {
    $("#contact-message").css("border-color", "#ff7c7c");
    _self
      .siblings(".contact-form-error")
      .text("What’s on your mind? Write your message here.")
      .show();
  } else {
    callApi = true;
  ...
  if (callApi) {
    ...
    $.ajax(settings)
      .done(function (response) {
        ...
        $(".contact-form-success").text(response.message).show();
        setTimeout(() => $(".contact-form-success").hide(), 5000);
      })
      .fail(function (e) {
        $(".contact-form-success").hide();
        _self
